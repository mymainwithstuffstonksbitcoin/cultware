...
backgroundcolor = Color3.fromRGB(204, 43, 94),
tabstextcolor = Color3.fromRGB(204, 43, 94),
bordercolor = Color3.fromRGB(204, 43, 94),
accentcolor = Color3.fromRGB(204, 43, 94),
accentcolor2 = Color3.fromRGB(230, 230, 230),
...
watermark.text = "valiant" .. name:gsub("{game}", gamename):gsub("{fps}", "0 FPS") .. " "
...
watermark.label.TextSize = 13.000
